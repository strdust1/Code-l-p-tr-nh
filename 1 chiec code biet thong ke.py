...
số_lần = 0 
while số_lần<= 2:
    if mat_khau == "Stardust" and tai_khoan == "NguyenHaVu":
        ...
        while True:
            ...
            if a == "không":
                ...
                b = str(input("Hãy nhập số từ 1 đến 7 ứng các lựa chọn trên: "))
        #2.Thêm sản phẩm        
                if b == "1":
        ...
        số_lần+=1
        print("Đã nhập sai mật khẩu hoặc tài khoản, còn",3 -số_lần, " lần thử, hãy nhập lại")
        tai_khoan = str(input("Hãy nhập tài khoản của bạn: "))
        mat_khau = str(input("Hãy nhập mật khẩu: "))  
        if số_lần > 2:
            print("Tài khoản đã bị khóa, về ăn rau má đi kưng")
